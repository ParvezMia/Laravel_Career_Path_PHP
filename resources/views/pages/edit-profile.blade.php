                        ...
                        <div class="col-span-full mt-10 pb-10">
                            ...
                            <div x-data="{ imagePreview: 'https://avatars.githubusercontent.com/u/831997' }" class="mt-2 flex items-center gap-x-3">
                                <input class="hidden" type="file" name="avatar" id="avatar" accept="image/*"
                                    ...
                                    " />
                                <img class="h-12 w-12 rounded-full object-cover" :src="imagePreview" alt="User Avatar" />
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea id="bio" name="bio" rows="3"
                                class="block w-full rounded-md border-0 p-2 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6">{{ $user->bio ? $user->bio : 'Less Talk, More Code 💻' }}</textarea>
                            @error('bio')
                                <small class="text-red-500">{{ $message }}</small>
                            @enderror
                        </div>
